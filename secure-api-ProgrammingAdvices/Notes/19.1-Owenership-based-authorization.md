...
### 2️⃣ The Vulnerability: Horizontal Privilege Escalation
    ...
    A user accessing data belonging to another user with the same role
...
### Two values are compared to enforce ownership

- correctJWT StudentId and Route StudentId
